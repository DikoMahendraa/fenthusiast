  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-muted/30">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-20 right-10 w-40 h-40 border-2 border-primary/10 rounded-full"
          animate={{ rotate: -360 }}
          transition={{ duration: 25, repeat: Number.POSITIVE_INFINITY, ease: "linear" }}
        />
        <motion.div
          className="absolute bottom-20 left-10 w-28 h-28 border-2 border-accent/10"
          animate={{ rotate: 360 }}
      ...
      >
        <Card className="border-2 shadow-lg">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-2xl font-space-grotesk">Buat Akun Baru</CardTitle>
            <p className="text-muted-foreground">Mulai perjalanan belajar frontend Anda hari ini</p>
          </CardHeader>
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button type="button" variant="outline" onClick={() => handleSocialLogin("google")} className="h-11">
              ...
              <Button type="button" variant="outline" onClick={() => handleSocialLogin("github")} className="h-11">
